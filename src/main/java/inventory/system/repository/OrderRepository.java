...
public interface OrderRepository extends CrudRepository<Order, String> {
    ...
    @Query("select a from Order a where a.origin_id=:warehouse_id " +
            "AND a.origin_type='Gudang' order by a.updated_at desc")
    List<Order> findByWarehouseOrigin(@Param("warehouse_id") String warehouse_id);


    @Query("select a from Order a where a.dest_id=:warehouse_id " +
            "AND a.dest_type='Gudang' order by a.updated_at desc")
    List<Order> findByWarehouseDest(@Param("warehouse_id") String warehouse_id);
